  ...
  return (
    <div >
        ...
        <div className="d-flex justify-content-center ">
            <input onClick={submit}  style={{paddingLeft: 2.5+'rem', paddingRight: 2.5+'rem'}} type="submit" id="submitDetails" name="submitDetails" className="btn btn-primary btn-lg registerbtn" value="Login" />  
            </div>
            <br></br>
